...
public class Fecha {
	...
	public static final SimpleDateFormat FECHA_GUIONES = new SimpleDateFormat("dd-MM-yyyy");

	public static final SimpleDateFormat FECHA = new SimpleDateFormat("dd/MM/yyyy", Locale.forLanguageTag("es"));
	public static final SimpleDateFormat FECHA_HORA = new SimpleDateFormat("dd/MM/yyyy HH:mm", Locale.forLanguageTag("es"));
	public static final SimpleDateFormat FECHA_CALENDAR = new SimpleDateFormat("yyyy-MM-dd", Locale.forLanguageTag("es"));

	public static final SimpleDateFormat FECHA_DIA = new SimpleDateFormat("EEEE dd", Locale.forLanguageTag("es"));

	private static final Fecha instance = new Fecha();

	public static final NumberFormat FORMATO_INGLES;
	public static final NumberFormat FORMATO_ESPANOL;
